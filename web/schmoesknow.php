...
<body class="background">
	<br>
	<?php
	$query="SELECT A.*, B.YouTubeLink, B.KristianScore, B.MarkScore FROM movies A, schmoesknow B WHERE A.Title = B.Title;";
	if($r=mysql_query($query)){
		echo '<table id="t01"><tr><th>MOVIE</th><th>INFORMATION</th><th>KRISTIAN\'S SCORE</th><th>MARK\'S SCORE</th></tr>';
		while($row=mysql_fetch_array($r)){
			echo
				...
				. '</td><td>' . $row['KristianScore'] . '/100'
        . '</td><td>' . $row['MarkScore'] . '/100 </td></tr>';
		}
		echo "</table>";
	}
	?>
