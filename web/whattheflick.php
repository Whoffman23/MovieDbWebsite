...
<body class="background">
	<br>
	<?php
	$query="SELECT A.*, B.YouTubeLink, B.Score FROM movies A, whattheflick B WHERE A.Title = B.Title;";
	if($r=mysql_query($query)){
		echo '<table id="t01"><tr><th>MOVIE</th><th>INFORMATION</th><th>SCORE</th></tr>';
